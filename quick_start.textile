...
You can also pass nested Rbjs as arguments. This functionality, too, be arbitrarily nested.
...
Caution must be bewared when working with local ruby variables and not get confused. The following Rbjs example will not render what you expect.
