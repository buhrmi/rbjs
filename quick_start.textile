...
{% highlight ruby %}
# Result:
# jQuery(".message").each(function(element, index) {
#   console.log(index.toString() + " is " + element);
# })
jQuery('.message').each do |element, index|
  console.log index.toString! + " is " + element
end
{% endhighlight %}
...
This documentation is currently being written (last update: Nov. 5). Check back soon.